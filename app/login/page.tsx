...
export default function LoginPage() {
    return (
        <div className='relative flex min-h-screen items-center justify-center overflow-hidden bg-linear-to-b from-white via-blue-50 to-blue-100 px-6 py-12 text-slate-900'>
            ...
            <div className='relative z-10 grid w-full max-w-5xl overflow-hidden rounded-3xl border border-blue-100/70 bg-white/95 shadow-2xl backdrop-blur md:grid-cols-[1.05fr_1fr]'>
                <div className='flex flex-col justify-between gap-10 border-b border-blue-100/80 bg-linear-to-b from-white to-blue-50 p-8 md:border-b-0 md:border-r md:p-10'>
                    <div className='space-y-6'>
                        <Badge className='w-fit border border-blue-200 bg-blue-50 text-xs font-semibold uppercase tracking-[0.3em] text-blue-700'>
                            Selamat datang
                        </Badge>
                        <div className='space-y-4'>
                            ...
                            <p className='text-sm text-slate-600 md:text-base'>
                                Pilih peran login agar dashboard Anda otomatis
                                menyesuaikan kebutuhan booking, operasional,
                                maupun laporan.
                            </p>
                        </div>
                        <div className='grid gap-4 text-sm text-slate-600'>
                            <div className='flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-3 text-blue-800'>
                                ...
                                <div className='space-y-1'>
                                    ...
                                    <p>
                                        Data booking, jadwal barber, dan laporan
                                        owner tersinkron otomatis.
                                    </p>
                                </div>
                            </div>
                            <div className='flex items-start gap-3 rounded-2xl border border-blue-100 bg-white p-3'>
                                <span className='flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-700'>
                                ...
                                <div className='space-y-1'>
                                    ...
                                    <p>
                                        Setiap peran hanya melihat fitur yang
                                        relevan sehingga operasional tetap aman.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='rounded-2xl border border-blue-100 bg-white p-4 text-sm text-slate-500'>
                        ...
                        <p>
                            Hubungi support@trimtime.id untuk reset akun owner
                            atau barber Anda.
                        </p>
                    </div>
                </div>
                <div className='flex flex-col gap-8 bg-white/90 p-8 md:p-10'>
                    <div className='space-y-2 text-center md:text-left'>
                        ...
                        <p className='text-sm text-slate-500'>
                            Pilih akses yang tepat agar pengalaman TrimTime
                    ...
                    <div className='space-y-3 rounded-2xl border border-slate-100 bg-slate-50 p-5 text-sm text-slate-500'>
                        ...
                        <p className='text-center text-xs text-slate-400 md:text-left'>
                            Akses admin internal dikelola terpisah oleh tim
                            TrimTime.
                        </p>
                    </div>
                </div>
