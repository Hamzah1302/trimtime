                    ...
                    <div className='flex flex-col gap-4 rounded-2xl border border-border/50 bg-card/85 p-6 shadow-sm backdrop-blur-sm lg:flex-row lg:items-center lg:justify-between'>
                        <div className='space-y-2'>
                            ...
                            <h1 className='text-3xl font-bold tracking-tight lg:text-4xl'>
                                Kelola tiket pengaduan
                            </h1>
                            <p className='text-sm text-muted-foreground lg:text-base'>
                                Auto-reply, statistik masalah, dan eskalasi
                                antar tim.
                            </p>
                        </div>
                ...
                <Card className='border-border/50 shadow-sm'>
                    <CardHeader className='flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between'>
                        <div>
                            ...
                            <CardDescription>
                                Kumpulan tiket dari owner, freelancer, dan user.
                            </CardDescription>
                        </div>
                        <Input
                            placeholder='Cari tiket/subject'
                ...
                <div className='grid gap-5 lg:grid-cols-2'>
                    <Card className='border-border/50 shadow-sm'>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Balasan cepat via WhatsApp/email.
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card className='border-border/50 shadow-sm'>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Kelompokkan komplain per kategori.
                            </CardDescription>
                        </CardHeader>
                ...
                <Card className='border-border/50 shadow-sm'>
                    ...
                    <CardContent className='space-y-3 text-sm text-muted-foreground'>
                        <div className='rounded-xl border border-border/40 bg-muted/15 p-4'>
                            ...
                            <p>
                                Kirim alert tiket prioritas tinggi ke channel
                                #trimtime-alert.
                            </p>
                        </div>
                        <div className='rounded-xl border border-border/40 bg-muted/15 p-4'>
                            ...
                            <p>
                                Komplain pelanggan dapat diarahkan ke owner jika
                                terkait layanan internal.
                            </p>
                        </div>
                    </CardContent>
                </Card>
