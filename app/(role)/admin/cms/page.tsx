                    ...
                    <div className='flex flex-col gap-4 rounded-2xl border border-border/50 bg-card/85 p-6 shadow-sm backdrop-blur-sm lg:flex-row lg:items-center lg:justify-between'>
                        <div className='space-y-2'>
                            ...
                            <h1 className='text-3xl font-bold tracking-tight lg:text-4xl'>
                                Kelola banner, artikel, dan barber unggulan
                            </h1>
                            <p className='text-sm text-muted-foreground lg:text-base'>
                                Pastikan semua kampanye tampil konsisten di
                                aplikasi user & portal owner.
                            </p>
                        </div>
                ...
                <Tabs defaultValue='banner' className='space-y-4'>
                    ...
                    <TabsContent value='banner' className='space-y-4'>
                        <Card className='border-border/50 shadow-sm'>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Disinkronkan ke homepage aplikasi user.
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card className='border-border/50 shadow-sm'>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Upload visual dan tentukan segmentasi.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className='space-y-4'>
                                <div className='grid gap-4 sm:grid-cols-2'>
                                    <div className='space-y-2'>
                                        ...
                                        <Input
                                            id='banner-title'
                                            placeholder='TrimTime Weekend Sale'
                                        />
                                    </div>
                                    <div className='space-y-2'>
                                        <Label htmlFor='banner-slot'>
                                            Posisi
                                        </Label>
                                        <Input
                                            id='banner-slot'
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <Textarea
                                        id='banner-desc'
                                        rows={3}
                                        placeholder='Highlight benefit promo, CTA, dsb'
                                    />
                                </div>
                    ...
                    <TabsContent value='artikel' className='space-y-4'>
                        <Card className='border-border/50 shadow-sm'>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Tampilkan edukasi perawatan dan event
                                    komunitas.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className='space-y-4'>
                                {[
                                    {
                                        title: "Workshop styling Bandung",
                                        date: "12 Feb",
                                        status: "Live",
                                    },
                                    {
                                        title: "Tips home service aman",
                                        date: "10 Feb",
                                        status: "Draft",
                                    },
                                ].map((item) => (
                    ...
                    <TabsContent value='featured' className='space-y-4'>
                        <Card className='border-border/50 shadow-sm'>
                            <CardHeader>
                                <CardTitle className='text-xl font-semibold'>
                                    Barber unggulan & sponsor
                                </CardTitle>
                                <CardDescription>
                                    Tentukan barber yang tampil di hero user.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className='space-y-3 text-sm text-muted-foreground'>
                                {[
                                    {
                                        name: "Rama Putra",
                                        metric: "Rating 4.95 • 120 booking",
                                    },
                                    {
                                        name: "Naya Pratama",
                                        metric: "Freelancer otw • 98 booking",
                                    },
                                ].map((item) => (
                                    <div
                                        key={item.name}
