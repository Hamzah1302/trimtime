                        ...
                        <CardContent className='space-y-4'>
                            ...
                            <div className='space-y-3'>
                                <h1 className='text-3xl font-bold tracking-tight lg:text-4xl'>
                                    Pantau perjalanan freelancer dalam sekali
                                    klik
                                </h1>
                                <p className='max-w-2xl text-sm text-muted-foreground lg:text-base'>
                                    Update status perjalanan (on the way → tiba
                                    → selesai), pantau estimasi jarak & ongkir,
                                    dan pastikan pelanggan menerima notifikasi
                                    otomatis.
                                </p>
                            </div>
                            <div className='flex flex-wrap gap-2 text-xs text-muted-foreground'>
                                <Badge className='bg-primary/10 text-primary'>
                                    Auto-sync dashboard owner
                                </Badge>
                                <Badge
                                    variant='outline'
                                    className='border-border/50 text-[10px] uppercase tracking-widest text-muted-foreground'
                                >
                                    Notifikasi realtime pelanggan
                                </Badge>
                            </div>
                        </CardContent>
                    </Card>
