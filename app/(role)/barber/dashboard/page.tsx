...
// --- PERUBAHAN: Data summaryMetrics disinkronkan ---
const summaryMetrics = [
	{
		label: "Booking Hari Ini",
		value: "4 pelanggan", // <-- Diubah dari 8
		helper: "1 menunggu check-in", // <-- Diubah dari "6 sudah dikonfirmasi"
	...
	},
	{
		...
		value: "1 Klien", // <-- Diubah dari "3 Selesai"
		helper: "Reyhan Fadil (On the way)", // <-- Diubah dari "1 belum Selesai"
...
// --- PERUBAHAN: Data klien ini sekarang jadi "source of truth" ---
const todaysClients = [
	{
		id: "TT-3021",
		name: "Dimas Saputra",
	...
	},
	{
		...
		status: "On the way",
		statusTone: "tracking", // <-- 1 Ongoing (dihitung sebagai "dikerjakan")
	...
	},
	{
		...
		status: "Selesai",
		statusTone: "done", // <-- 1 Done
		channel: "Walk-in",
	},
] as const; // Total 4 Klien

// --- PERUBAHAN: Data bookingFunnel disinkronkan (total 4) ---
const bookingFunnel = [
	{
		label: "Menunggu Konfirmasi",
		current: 1, // <-- Diubah dari 2 (sesuai data Dimas)
		total: 4, // <-- Diubah dari 8
		tone: "pending",
	},
	{
		label: "Sedang Dikerjakan",
		current: 2, // <-- Diubah dari 3 (sesuai data Hafidz + Reyhan)
		total: 4, // <-- Diubah dari 8
		tone: "ongoing",
	},
	{
		label: "Sudah Selesai",
		current: 1, // <-- Diubah dari 3 (sesuai data Vino)
		total: 4, // <-- Diubah dari 8
		tone: "done",
	},
] as const;
	...
	return (
		<PageShell background="soft" contentClassName="gap-0">
			<section className="relative overflow-hidden bg-linear-to-br from-primary/5 via-background to-accent/5 px-5 py-8 lg:px-8 lg:py-3">
				...
				<div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
					...
					<div className="flex flex-col items-start gap-3 rounded-2xl border border-border/40 bg-card/80 p-4 shadow-sm backdrop-blur lg:items-end">
						...
						<div className="flex flex-wrap gap-2">
							{/* --- PERUBAHAN: Teks tombol diperjelas --- */}
							<Button
								variant="outline"
				...
				{/* --- PERUBAHAN: Wrapper grid dihapus & Kartu Smart Break digabung --- */}
				<div className="mt-6">
					<Card className="border-border/50 shadow-sm">
						...
						<CardContent className="space-y-3">
							...
							{/* Menggabungkan info status dan info "Smart Break" yang aktif */}
					...
					{/* --- PERUBAHAN: Kartu "Smart Break" yang terpisah dihapus --- */}
					{/* Kartu ini tidak lagi diperlukan karena fungsinya sudah digabung di atas */}
				</div>
