...
const insights = [
    { label: "Rating rata-rata", value: "4.86 / 5", helper: "+0.2 vs minggu lalu" },
    { label: "Ulasan baru", value: "1.247", helper: "62% mention barber tertentu" },
        ...
        <PageShell background='soft' contentClassName='gap-0'>
                ...
                <div className='relative space-y-6'>
                    <div className='flex flex-col gap-4 rounded-2xl border border-border/50 bg-card/85 p-6 shadow-sm backdrop-blur-sm lg:flex-row lg:items-center lg:justify-between'>
                        <div className='space-y-2'>
                            ...
                            <h1 className='text-3xl font-bold tracking-tight lg:text-4xl'>Pantau ulasan & respons</h1>
                            <p className='text-sm text-muted-foreground lg:text-base'>
                                Balas ulasan, analisis rating per barber, dan bandingkan pelanggan baru vs loyal.
                            </p>
                        </div>
            ...
            <main className='space-y-6 px-5 py-6 lg:px-8 lg:py-8'>
                ...
                <Tabs defaultValue='reviews' className='space-y-4'>
                    <TabsList>
                        <TabsTrigger value='reviews'>Ulasan terbaru</TabsTrigger>
                        <TabsTrigger value='analysis'>Analisis rating</TabsTrigger>
                    </TabsList>
                    <TabsContent value='reviews' className='space-y-3'>
                        {reviews.map((review) => (
                            <Card key={review.customer} className='border-border/50 shadow-sm'>
                                    ...
                                    <div className='flex w-full flex-col gap-2'>
                                        <div className='flex items-center gap-3'>
                                            <Avatar className='h-10 w-10 border border-border/40'>
                                                <AvatarFallback>{review.customer.slice(0, 2)}</AvatarFallback>
                                            </Avatar>
                                            <div>
                                        ...
                                        <p className='text-sm text-muted-foreground'>{review.highlight}</p>
                                    </div>
                                    <Button variant='outline' className='border-border/60'>
                                        Balas pelanggan
                                    </Button>
                    ...
                    <TabsContent value='analysis'>
                        <Card className='border-border/50 shadow-sm'>
                            <CardHeader>
                                <CardTitle className='text-xl font-semibold'>Rating per barber & pelanggan</CardTitle>
                                <CardDescription>Insight pelanggan baru vs lama.</CardDescription>
                            </CardHeader>
                            <CardContent className='grid gap-4 sm:grid-cols-2'>
                                ...
                                <div className='rounded-xl border border-border/40 bg-muted/15 p-4 text-sm text-muted-foreground'>
                                    ...
                                    <p>Baru 38% • Lama 62% (target 70% loyal)</p>
                                    <p>Rekomendasi: aktifkan promo loyal tier</p>
                                </div>
                                <div className='rounded-xl border border-border/40 bg-muted/15 p-4 text-sm text-muted-foreground'>
                                    <p className='flex items-center gap-2 text-foreground font-semibold'>
                                    ...
                                    <p>“Home service”, “steam therapy”, “booking cepat”</p>
                                </div>
                                <div className='rounded-xl border border-border/40 bg-muted/15 p-4 text-sm text-muted-foreground'>
                                    <p className='flex items-center gap-2 text-foreground font-semibold'>
