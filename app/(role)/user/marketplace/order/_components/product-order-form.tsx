...
export function ProductOrderForm({ product }: ProductOrderFormProps) {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const address = formData.get("buyer-address")?.toString().trim();

        const params = new URLSearchParams({
            barbershopName: product.barbershop.name,
            serviceName: product.name,
            servicePrice: String(subtotal),
        ...
        router.push(
            `/user/payment/${product.barbershop.id}?${params.toString()}`
        );
    };
            ...
            <div className='space-y-6'>
                    ...
                    <CardHeader className='border-b border-border/50'>
                        <div className='flex items-start justify-between gap-3'>
                            <div>
                                ...
                                <CardDescription>
                                    Atur kuantitas produk dan catatan khusus
                                    untuk barber.
                                </CardDescription>
                            </div>
                    ...
                    <CardContent className='space-y-5 py-6'>
                        <div className='space-y-3'>
                            ...
                            <p className='text-xs text-muted-foreground'>
                                Maksimal 10 item per transaksi. Hubungi barber
                                untuk jumlah besar.
                            </p>
                        </div>
                ...
                <Card className='gap-0 border-border/60'>
                    <CardHeader className='border-b border-border/50'>
                        ...
                        <CardDescription>
                            Pastikan detail kontak benar agar barber mudah
                            menghubungi.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className='space-y-4 py-6'>
                    ...
                    <CardContent className='space-y-4 py-6'>
                        <div className='space-y-3'>
                            ...
                            <RadioGroup
                                ...
                                onValueChange={(value) =>
                                    setPayment(
                                        value as (typeof paymentOptions)[number]["id"]
                                    )
                                }
                                className='space-y-3'
                            >
                        ...
                        <div className='rounded-xl border border-border/50 bg-muted/30 p-4 text-xs text-muted-foreground'>
                            ...
                            <p className='mt-2 leading-relaxed'>
                                Pembayaran diproses melalui mitra resmi. Barber
                                menerima notifikasi otomatis setelah transaksi
                                berhasil.
                            </p>
                ...
                <Card className='gap-0 border-border/60'>
                    ...
                    <CardContent className='space-y-4 py-6 text-sm'>
                        ...
                        <div className='space-y-2 rounded-lg border border-primary/30 bg-primary/5 p-3 text-xs text-muted-foreground'>
                            ...
                            <p>
                                Dana kamu aman dan baru diteruskan ke barber
                                setelah pesanan dikonfirmasi diterima.
                            </p>
                        </div>
                    </CardContent>
