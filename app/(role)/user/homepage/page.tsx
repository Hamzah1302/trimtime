                    ...
                    <div className='flex items-start justify-between'>
                        <div className='flex-1 space-y-3'>
                            ...
                            <p className='text-sm text-muted-foreground lg:text-base'>
                                Booking mudah, barber profesional, hasil
                                maksimal
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div className='flex-1'>
                                ...
                                <p className='text-xs text-muted-foreground'>
                                    Temukan yang terdekat denganmu
                                </p>
                            </div>
                        </button>
                    </div>
                        ...
                        <div className='group relative overflow-hidden rounded-2xl border border-border/50 bg-card shadow-lg transition-all hover:shadow-xl lg:h-[400px]'>
                            <div className='relative h-64 overflow-hidden lg:h-full'>
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(${barbershopDatabase.list[0].heroImage})`,
                                    }}
                                />
                    ...
                    <div className='space-y-5'>
                        ...
                        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
                            {barbershopDatabase.list.slice(1).map((shop) => (
                                ...
                                >
                                    <div className='relative aspect-5/4 w-full overflow-hidden sm:aspect-4/3 xl:aspect-video'>
                                        <div
