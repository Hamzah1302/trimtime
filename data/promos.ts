...
export const promoCollection: {
    ...
    featured: {
        ...
        description:
            "Dapatkan potongan rambut + styling pomade premium khusus minggu ini.",
        discountLabel: "25%",
        barbershopId: "1",
    ...
    recommendations: [
        {
            ...
            description:
                "Nikmati layanan barber ke rumah tanpa biaya tambahan transportasi.",
            ...
            terms: [
                "Minimal transaksi Rp 80.000",
                "Hanya di area Jakarta Selatan",
            ],
            code: "HOMEFREE10",
        },
        {
            ...
            description:
                "Potongan khusus pelajar & mahasiswa setiap Senin-Kamis.",
            ...
            terms: [
                ...
                "Tunjukkan kartu pelajar saat check-in",
            ],
            code: "STUDENT20",
        },
        {
            ...
            description:
                "Paket lengkap untuk tampilan gentleman, hemat Rp 35.000.",
            ...
            terms: [
                "Termasuk complimentary espresso",
                "Dapatkan poin member 2x",
            ],
            code: "GENTLEMEN15",
        },
    ],
